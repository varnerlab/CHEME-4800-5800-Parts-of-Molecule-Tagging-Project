...
For example, C6H12O6 would give C=> 6, H=>12, and O=> 6.  The second component will use the composition dictionaries to tell the user if a chemical reaction is balanced and if the reaction is unbalanced, it will return which elements are incorrect and by how much. Test your project on datasets with known errors and then on unseen data.
